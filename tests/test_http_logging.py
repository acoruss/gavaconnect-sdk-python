...
class TestLogRequest:
    ...
    @pytest.mark.asyncio
    async def test_log_request_basic(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_log_request_with_authorization_header(self, caplog):
...
class TestLogResponse:
    ...
    @pytest.mark.asyncio
    async def test_log_response_basic(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_log_response_without_start_time(self, caplog):
    ...
    @pytest.mark.asyncio
    async def test_log_response_without_request_id(self, caplog):
